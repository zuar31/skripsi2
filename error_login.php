  ...
  <body class="animsition page-error page-error-400 layout-full">
    ...
    <div class="page vertical-align text-center" data-animsition-in="fade-in" data-animsition-out="fade-out">
      <div class="page-content vertical-align-middle">
        ...
        <p class="error-advise">Silakan masukan username dan password kembali</p>
        <a class="btn btn-primary btn-round" href="login.php">GO TO LOGIN PAGE</a>

        <footer class="page-copyright">
          <p>APPLIKASI MONITORING SERANGAN FLOODING ATTACK</p>
