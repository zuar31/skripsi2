...
<head>
    ...
    <title>Sign In FIST Schedule Assistant with Telegram API</title>
    <!-- Custom CSS -->
            ...
            <div class="auth-box">
                <div id="loginform">
                    <div class="logo">
                        ...
                        <h5 class="font-medium m-b-20">Sign In to Login</h5>
                    </div>
                    <!-- Form -->
                    <div class="row">
                        <div class="col-12">
                            <form class="form-horizontal m-t-20" id="loginform" action="cek_login.php" method="POST">
